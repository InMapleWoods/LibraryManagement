...
namespace LibraryManagement.Circulation
{
    public partial class BookBorrowForm : Form
    {
        ...
        private void GetReader(int readerId)
        {
            ...
            validityTermTextBox.Text = reader.ValidityTerm.ToString() + "天";
        }
        ...
        private void DeleteLog_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (circulationBll.RemoveBorrowLog(int.Parse(idTextBox.Text)))//调用订单删除方法
                    {
